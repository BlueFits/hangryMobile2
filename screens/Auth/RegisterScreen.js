        ...
        <View style={styles.main}>
            <ImageBackground
                ...
                <View style={styles.container}>
                    ...
                    <TouchableOpacity style={{ alignSelf: "center", marginTop: 15, marginBottom: 50 }} onPress={() => navigation.navigate("Login")}>
                        <Text style={{ color: "#414959", fontSize: 13 }}>
                            Already have an account? <Text style={{ fontWeight: "500", color: "#F55E2D" }}>Login</Text>
                        </Text>
                    </TouchableOpacity>
